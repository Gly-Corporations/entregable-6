...
const DeleteRole = ({ show, setShowFunction }) => {
    ...
    const submit = () => {
        ...
        axios.delete(`https://api-ecommerce-production-ca22.up.railway.app/api/v1/role/${roleNumber}`, getConfig())
            .then(() => {
        ...
        >
            ...
            <Modal.Body>
                ...
                <Form onSubmit={submit}>
                    ...
                    <button type="submit" className="btn_admin">Delete Role</button>
                </Form>
            </Modal.Body>
        </Modal>
    );
